...
public class MailService {
	...
	public synchronized void sendEMail(String emailId, String subject, String msg){
        ...
        try {
               ...
               mimeHelper.setFrom("xxxxxxxxxxx@gmail.com");
	...
	public synchronized void sendpasswordemail(String emailId){
		...
		try {
			...
			mimeHelper.setFrom("xxxxxxxxxxxxxx@gmail.com");
			mimeHelper.setSubject("Password Reset");
			mimeHelper.setText("<html><body>hi,<br/><a href='http://xxxxxxxxxxxxxxxx/tracktrackerspring/resetpassword'> Click here</a> to reset password</body></html>",true);
			mailSender.send(message);
		} catch (MessagingException e) {
			System.out.println("Error Sending email "+ e.getMessage());
		}
